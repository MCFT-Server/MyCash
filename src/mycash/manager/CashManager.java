...
public class CashManager {
	 ...
	 * 
	 * @param pinNumber
	 *            pinNumber pattern is xxxx-xxxx-xxxx-xxxxxx or
	 *            xxxx-xxxx-xxxx-xxxx
	 * @return boolean
	 */
	public boolean isRightPinNumber(String pinNumber) {
		return Pattern.matches(".... .... .... ....", pinNumber) ? true
				: Pattern.matches(".... .... .... ......", pinNumber);
	}
	...
	public boolean hasChargeList() {
		if (getDB().getDB("waitlist").getAll().size() != 0)
			return true;
		else
			return false;
	}
